...
# wartość p < alfa = 0.05 - odrzucamy hipotezę zerową
...
# wartość p > alfa = 0.05 - nie mamy podstaw do odrzucenia H0
...
shapiro.test(smog2017$t2m_mean_daily)
# wartość p < alfa = 0.05 - odrzucamy hipotezę zerową
...
skewness(smog2017$t2m_mean_daily)
kurtosis(smog2017$t2m_mean_daily)
